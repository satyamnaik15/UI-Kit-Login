package door.cyron.house.housedoor.utility.expandablelayout;
...
import door.cyron.house.housedoor.utility.expandablelayout.util.FastOutSlowInInterpolator;

import static door.cyron.house.housedoor.utility.expandablelayout.ExpandableLayout.State.*;
...
public class ExpandableLayout extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int size = orientation == LinearLayout.VERTICAL ? width : height;
